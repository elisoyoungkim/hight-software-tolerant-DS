...
public class ProcessMulticastRequest {
	String replicaID="meet";
	String ipForLeader="132.205.93.59";
	
	public void request(String msg){
		//fetch the request came & divide appropriately
		...
		//depending on the ip address, send to that specific server
		int port=0;
		...
		//attach the replica-id & reply back to the leader
